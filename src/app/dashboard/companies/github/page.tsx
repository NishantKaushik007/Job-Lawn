import { jobCategory, industryExp, location, category, experienceLevel } from '../../../../Data/data';
...
async function fetchJobs(filters: Record<string, string | undefined>, page: number): Promise<Job[]> {
    ...
    const queryParams = [
        ...
        filters.industryExp && `tags4=${filters.industryExp}`,
        filters.category && `tags6=${filters.category}`,
        filters.experienceLevel && `tags5=${filters.experienceLevel}`,
    ...
    const url = `https://www.github.careers/api/jobs?${queryParams}&sortBy=relevance&descending=false&internal=false&deviceId=undefined&domain=githubinc.jibeapply.com&page=${page}`;
